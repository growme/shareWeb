...
<html>
<head>
<title>${SYSPARAM.SITE_NAME}_微信提现</title>
...
<body class="yzk_bg">
    ...
    <div class="yzk_content">
        ...
        <div class="wx_tixian_money">
        	<p class="wx_tixian_txt01" <c:if test="${!empty MSESSION_USER.payAccount}"> style="background:#fafafa" </c:if>>
                ...
                <input type="text" id="payAccount" name="payAccount" <c:if test="${!empty MSESSION_USER.wechat}"> style="background:#fafafa" readonly</c:if> placeholder="请输入您的微信账户" value="${MSESSION_USER.wechat}">
            </p>
            <p class="wx_tixian_txt01" <c:if test="${!empty MSESSION_USER.accountName}"> style="background:#fafafa" </c:if>>
                <input type="text" id="accountName" name="accountName" <c:if test="${!empty MSESSION_USER.accountName}"> style="background:#fafafa" readonly</c:if> placeholder="请输入微信实名姓名" value="${MSESSION_USER.accountName}">
            </p>      
            <p class="wx_tixian_txt01">
               ...
               <%--<span class="cash_info">
	              <span class="cashspan" style="background:#fc30a0;">10</span>
	              <span class="cashspan" style="background:#fc30a0;">30</span>
	              <span class="cashspan" style="background:#fc30a0;">50</span>
	              <span class="cashspan" style="background:#fc30a0;">100</span>
	              <span class="cashspan" style="background:#fc30a0;">150</span>
               </span>
            --%></p>   
            ...
            <p class="wx_tixian_txt01">
                <input type="text" id="checkCode" name="checkCode" placeholder="请输入短信验证码" value="">
                <a id="btnSendCode" name="btnSendCode" class="sqbtn">获取验证码</a>
            </p>      
            
            <div class="wx_tixian_btn02"><a href="javascript:void(0);" id="wxtx">立即提现</a></div>
    ...
    <script type="text/javascript" src="<%=path %>/static/script/user/draw/apply_wechat_draw.js"></script>
</body></html>