...
<title>${SYSPARAM.SITE_NAME}_今日徒弟收益</title>
...
<body class="yzk_bg">
	<header class="header">
		<div class="header-menu">
			...
			</a> <span class="title">徒弟收益</span> 
			<a href="${basePath}invited/dlist.html"><span class="menu"><i class="iconfont icon-vip"></i>&nbsp;我的徒弟</span>
			</a>
		</div>
	</header>
	<div class="yzk_content">
		<div class="yzk_yaoqing_menu">
			<ul>
				...
				<li>
				<a href="${basePath}invited/searn.html">今日徒孙收益</a>
				</li>
			</ul>
		</div>
