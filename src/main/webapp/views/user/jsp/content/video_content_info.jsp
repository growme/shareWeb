...
<body class="yzk_bg">
   ...
   <div class="yzk_artice_con" id="ctx_content">
    ...
    <div class="artice_top_ctime" style="margin-bottom:5px;">
     ...
     <c:if test="${!empty single_pic_random_adverts && isWeixin==1}">
	 ...
	 <c:if test="${!empty text_random_adverts && isWeixin==1}">
     ...
     <div class="artice_centent_con" id="art-cont" style="max-height:2.2rem">
      ...
      <div id="content">
		<p>
			...
			<video width="420" height="280" src="${content.videoLink}" preload="auto" controls="controls"></video>
		</p>
	 </div>
   ...
   <c:if test="${!empty float_advert && isWeixin==1}">
	<div class="tis">
    ...
    <!-- 广告列表 -->
     <c:if test="${!empty adverts && isWeixin==1}">
...
<c:if test="${!empty banner_adverts && isWeixin==1}">
