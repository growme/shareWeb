	...
	<div class="yzk_artice_con" id="ctx_content">
		<c:if test="${!empty single_pic_random_adverts && closeNovelAdv!=1}">
			<div class="tuijian"
				...
				<h3>${single_pic_random_adverts.adTitle}</h3>
				<span>${single_pic_random_adverts.adTagName}</span>
			</div>
		</c:if>
		<!-- <script type="text/javascript" smua="d=m&s=b&u=u3061392&h=20:6"
			src="//www.smucdn.com/smu0/o.js"></script> -->
			...
			<section class="container">
				<div class="list_dd bor_b" id="">
					<a class="link"
						...
						title="${banner_adverts[0].adTitle}"> <img
						...
						<ul>
							<li style="height: auto;"><a class="link"
								onclick="update_ad_href(this,${ad.adId})">
									<h2 class="title" style="line-height:.5rem;color:${adRanColor}">
										<span style="color:${adRanColor};"> ${ad.adTitle}<%-- <k
		...
		<div class="artice_centent_con" id="art-cont" style="max-height: 2rem">
			${content.contentText}
		...
		<div class="linebar baryd show-more"
			...
			<img src="${basePath}static/images/showmore${randMore}.jpeg"
				class="show-more-x"></img>
		</div>

	</div>

	<!-- <script type="text/javascript" smua="d=m&s=b&u=u3582103&h=20:6"
		src="//www.smucdn.com/smu0/o.js"></script>
	<script type="text/javascript" smua="d=m&s=b&u=u3061382&h=20:6"
		src="//www.smucdn.com/smu0/o.js"></script> -->
	<script type="text/javascript" smua="d=m&s=b&u=u3500579&h=20:6"
		src="//www.smucdn.com/smu0/o.js"></script>
	<!-- 广告列表 -->
...
window.onload = function(){
  ...
  var jump_link = ccnetpath + "nullxh"+getRandStr(4)+"?token="+token;
  function setHistory(backurl) {
   ...
   $(window).scroll(function() {
	...
	<div id="cnzz_code" style="display: none">
		<c:if test="${!empty SYSPARAM.SITE_CNZZ_COUNT_CODE}">
    ${SYSPARAM.SITE_CNZZ_COUNT_CODE}
 </c:if>
	</div>
</body>
</html>