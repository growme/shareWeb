	...
	<div class="yzk_artice_con" id="ctx_content">
						...
						<ul>
							<li style="height: auto;"><a class="link"
								onclick="update_ad_href(this,${ad.adId})">
									<h2 class="title" style="color:${adRanColor}">
		...
		<div class="artice_centent_con" id="art-cont"
			...
			<div id="content">
				...
				<%-- <video width="420" height="280" controls="" autoplay="autoplay"
					name="media">
					<source src="${content.videoLink}" type="video/mp4">
				</video> --%>
				<iframe src="${content.videoLink}" width="420" height="280"
					frameborder="1/0" name="iframe名称" scrolling="yes/no/auto">
				</iframe>
			</div>
		</div>
		...
		<div class="linebar baryd show-more"
			...
			<img src="${basePath}static/images/showmore1.jpeg"></img>
		</div>
