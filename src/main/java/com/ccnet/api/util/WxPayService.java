...
public class WxPayService {
	private static Logger MAIN_LOGGER = LoggerFactory.getLogger(WxPayService.class);
	...
	public static Map<String, String> post(String ip, String body, String billId, BigDecimal totaAmout, String domain,
		...
		try {
			...
			//
			String prepayid = WXUtil.getPrepayid(WXUtil._URL, xml);
	...
	public static void main(String[] a) {
		try {
			...
			// "3117320294629376", new BigDecimal(4.8), domain);
			// System.out.println(JSONObject.toJSONString(param))

			String d = "appid=wx3f209f659ed1a768&attach=支付测试&bank_type=CFT&fee_type=CNY&is_subscribe=Y&mch_id=10000100&nonce_str=5d2b6c2a8db53831f7eda20af46e531c&openid=oUpF8uMEb4qRXf22hE3X68TekukE&out_trade_no=1409811653&result_code=SUCCESS&return_code=SUCCESS&sub_mch_id=10000100&time_end=20140903131540&total_fee=1&trade_type=JSAPI&transaction_id=1004400740201409030005092168&key=Ylb201609A1376986948Hnpy00631869";
