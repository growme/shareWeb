...
public class ShortUrlTest {
	public static void main(String[] args) {
		String sLongUrl = "https://blog.csdn.net/zhangvalue/article/details/10320551"; // 长链接
	...
	public static String[] shortUrl(String url) {
		...
		String sMD5EncryptResult = CMyEncrypt.md5(key + url); // 对传入网址进行 MD5
																// 加密，key是加密字符串
		...
		for (int i = 0; i < 4; i++) {
			...
			// 这里需要使用 long 型来转换，因为 Inteter.parseInt() 只能处理 31 位 , 首位为符号位 , 如果不用
			// long ，则会越界
